...
const departments = ["CSE", "CSBS", "AI&DS", "CSE(AI&ML)"];

export function AdminBulkRefreshButton() {
  ...
  const startRefresh = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: `Updating all students in ${selectedDepartment} department...`,
      });
    },
    onError: (error: Error) => {
  ...
  const handleOpenDepartmentSelect = () => {
  ...
  const handleStartRefresh = () => {
    if (!selectedDepartment) {
      toast({
        ...
        description: "Please select a department to refresh",
        variant: "destructive",
      });
      return;
    }
    console.log("Starting bulk refresh for department:", selectedDepartment);
  ...
  return (
    <>
      <Button
        onClick={handleOpenDepartmentSelect}
      ...
      <Dialog open={showDepartmentSelect} onOpenChange={setShowDepartmentSelect}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Select Department</DialogTitle>
            <DialogDescription>
              Choose which department's students to refresh
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                disabled={!selectedDepartment || startRefresh.isPending}
              >
